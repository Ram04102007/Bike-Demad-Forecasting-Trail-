...
//     function Particles() {
//   const particles = [
//     { left:"13%", top:"8%",  dur:"6s", delay:"0s" },
//     { left:"27%", top:"23%", dur:"8s", delay:"1s" },
//     { left:"45%", top:"5%",  dur:"5s", delay:"2s" },
//     { left:"62%", top:"41%", dur:"7s", delay:"0.5s" },
//     { left:"78%", top:"15%", dur:"9s", delay:"1.5s" },
//     { left:"91%", top:"67%", dur:"6s", delay:"3s" },
//     { left:"5%",  top:"55%", dur:"8s", delay:"0.8s" },
//     { left:"33%", top:"78%", dur:"5s", delay:"2.5s" },
//     { left:"55%", top:"90%", dur:"7s", delay:"1.2s" },
//     { left:"70%", top:"32%", dur:"6s", delay:"3.5s" },
//     { left:"82%", top:"85%", dur:"9s", delay:"0.3s" },
//     { left:"18%", top:"48%", dur:"5s", delay:"1.8s" },
//     { left:"40%", top:"62%", dur:"8s", delay:"2.2s" },
//     { left:"95%", top:"20%", dur:"6s", delay:"0.6s" },
//     { left:"8%",  top:"88%", dur:"7s", delay:"3.2s" },
//     { left:"50%", top:"35%", dur:"5s", delay:"1.4s" },
//     { left:"72%", top:"72%", dur:"9s", delay:"2.8s" },
//     { left:"25%", top:"95%", dur:"6s", delay:"0.2s" },
//     { left:"88%", top:"50%", dur:"8s", delay:"1.6s" },
//     { left:"37%", top:"18%", dur:"7s", delay:"3.8s" },
//   ];
//   return (
    ...
    <main className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-8">
      <div className="text-center max-w-3xl">
        <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 text-sm text-indigo-300 mb-6">
          <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse" />
          Live · 8 Bangalore zones active
        </div>
        <h1 className="text-6xl font-bold mb-4">
          <span className="text-white">BikeSense</span>{" "}
          <span className="text-indigo-400">AI</span>
        </h1>
        <p className="text-slate-400 text-xl mb-10">
          SARIMA-powered bike demand forecasting for Bangalore
        </p>
        <div className="flex gap-4 justify-center">
          <Link href="/auth/signup?role=admin"
            className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-8 py-3 rounded-lg transition-all">
            Admin Dashboard →
          </Link>
          <Link href="/auth/signup?role=consumer"
            className="border border-white/20 hover:border-indigo-500/50 text-white font-semibold px-8 py-3 rounded-lg transition-all">
            Rider Dashboard →
          </Link>
        </div>
        <div className="mt-12 grid grid-cols-3 gap-8 text-center">
          {[["17,379","Training Records"],["94.2%","SARIMA Accuracy"],["8 Zones","Bangalore Coverage"]].map(([v,l])=>(
            <div key={l}>
              <div className="text-3xl font-bold text-indigo-400">{v}</div>
